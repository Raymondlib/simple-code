...
//                String path = "C:\\Users\\25755\\Desktop\\1级队列\\数据集\\anneal.ORIG.arff";
                ...
                for (int s = 0; s < cfs_real.length; s++) {
                    ...
                    for (int k = 3; k < 4; k += 2) {
                        ...
                        eva.crossValidateModel(c, trainIns, 10, new Random(1));
                        System.out.println(1 - eva.errorRate());
                        //                writeLog(cfs_name[s]+"pre"+"_anneal.ORIG_.txt",(1-eva.errorRate())+"\n");
                        writeLog("D:/project/java/leetcode/out/"+cfs_name[s]+"pre"+"_anneal.ORIG_.txt",(1-eva.errorRate())+"\n");

                        writeLog("D:/project/java/leetcode/out/"+cfs_name[s]+"rootMSE"+"_anneal.ORIG_.txt",(eva.rootMeanSquaredError())+"\n");
